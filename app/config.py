...
# Mild stress so edge can still surface on liquid FX/majors.
COST_STRESS = 1.15

# Balanced floors: still require OOS edge, but not so strict that the board stays empty.
MIN_OOS_TRADES = 8
MIN_EXPECTANCY_R = 0.02
MIN_PROFIT_FACTOR = 1.08
MIN_SIDE_TRADES = 5
MIN_WF_POSITIVE_FOLDS = 1
MAX_CALIBRATED_PROB = 75
MIN_RR = 2.0
ATR_STOP_MULT = 1.3
